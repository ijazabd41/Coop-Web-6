                        ...
                        {!isVariantInStock ? (
                          isAdded ? (
                            <div className="flex  items-center  justify-end w-[90px]">
                              <button
                                className="primaryBackColor text-white w-8 h-7 p-1   rounded-[4px]"
                                onClick={(e) =>
                              ...
                              />
                              <button
                                className=" w-8 h-7 primaryBackColor text-white p-1 rounded-[4px]"
                                onClick={(e) =>
                            ...
                            <button
                              className="flex gap-1 addToCartColor py-2 px-4 rounded-sm primaryColor justify-center font-semibold hover:primaryBackColor transition-all duration-300  hover:text-white"
