...
import { FaFacebookF, FaInstagram, FaMoon, FaSun, FaYoutube } from "react-icons/fa";
        ...
        <section className='border-b-2 '>
            ...
            <div className='headerBackgroundColor pb-3'>
                <div className='center-header headerBackgroundColor'>
                    <div className='container  flex justify-between items-center pb-[8px] md:py-[12px] lg:py-4 columns-3 border-b-2 lg:border-none md:border-none '>
