          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-1">
              ...
              <textarea
                ...
                className="p-2 cardBorder outline-none rounded-sm"
              ></textarea>
            </div>
            <div className="flex  gap-2 flex-wrap">
              ...
              <div
                className="cardBorder rounded-sm flex items-center justify-center p-12 w-12 h-10 "
            ...
            <div className="flex justify-end">
              <button
                className="primaryBackColor px-4 font-semibold text-base py-2 text-white rounded-sm"
