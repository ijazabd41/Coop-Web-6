...
const CategoryCard = ({ category }) => {
    ...
    return (
        <div className='flex flex-col category-card p-4 border border-transparent hover:textPrimaryColor hover:cardBorder rounded-lg categoryCardBackground cursor-pointer '>
