...
const CategoryCard = ({ category }) => {
    ...
    return (
        <div className='flex flex-col category-card p-3 border border-transparent hover:textPrimaryColor hover:cardBorder rounded-sm headerBackgroundColor cursor-pointer'>
