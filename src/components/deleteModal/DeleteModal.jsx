            ...
            <DialogContent>
                <div>
                    ...
                    <div className='flex gap-2 mt-3'>
                        <button className='px-4 py-1 bg-green-700 text-white font-bold rounded-sm' onClick={handleDelete}>{t("Ok")}</button>
                        <button className='px-4 py-1 bg-red-700 text-white font-bold rounded-sm' onClick={handleHideDelete}> {t("cancel")}</button>
                    </div>
                </div>
            </DialogContent>
        </Dialog>
