...
const CartProductsCard = () => {
    return (
        <div>
            <div className='grid grid-cols-12 p-2 cardBorder m-2 gap-2 rounded-sm'>
                <div className='col-span-3'>
                    <div className='h-full w-full object-cover aspect-square relative'>
                        <Image src={Demo} alt='Image' fill className='h-full w-full object-cover' />
                    </div>
                </div>
                    ...
                    <div className='flex flex-col justify-between h-full'>
                        ...
                        <div className='flex justify-between items-center'>
                            ...
                            <div className='flex gap-1 items-center'>
                                <h2 className='text-base font-bold'>$90</h2>
                                <p className='text-sm font-normal line-through'>$120</p>
                            </div>
                        </div>
                    </div>
                </div>
